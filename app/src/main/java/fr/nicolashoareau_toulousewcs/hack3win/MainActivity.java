...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<ArticlesModel> articleList = new ArrayList<>();
        al.add("android.resource://"+ getPackageName()+ "/" + R.raw.lelaboikos);
        al.add("c");
        al.add("python");
        al.add("java");
        al.add("html");
        ...
        arrayAdapter = new ArrayAdapter<>(this, R.layout.item, R.id.videoCard, al);
        /*fonction swipe*/
